...
#define MBEDTLS_OID_C  //Enable OID data structure
...
//When writing a PEM certificate, it is necessary
...
//padding method, choose between V15 or V21 modes
#define MBEDTLS_PKCS1_V21
#define MBEDTLS_PKCS1_V15

//Do not use the platform's default entropy source
 ...
 * at the same pace. The typical accuracy of an RTC crystal is 卤100 to 卤20 parts
